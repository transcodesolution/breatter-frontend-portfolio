...
const QA_Header = () => {
    ...
    return (
        <div className="qa_header_block" style={{ zoom: '125%' }}>
                            ...
                            <div className="mobile_menu">
                                <div className="menu_wrap">
                                    <ul className="menu_block">
                                        ...
                                        <li><NavLink activeClassName='is-active' to="/QuestionPage1">Q & A</NavLink></li>
                                        <li><NavLink activeClassName='is-active' to="/SlotBookpage">Book Slote</NavLink></li>
                                        <li><NavLink activeClassName='is-active' to="/QuestionAnswer">Upload</NavLink></li>
                                        <li><NavLink activeClassName='is-active' to="/Subscriptionpage">Subscription</NavLink></li>
                                        <li><NavLink activeClassName='is-active' to="/ChatUspage">Chat </NavLink></li>
                                    </ul>
                                </div>
                                            ...
                                            {!token ? <NavLink to="/Loginpage">Login</NavLink> : <>   <div className="comman_btn">
                                                <div className="qa_profile">
                                                    <a href="#0" style={{ padding: '0px' }}>
                                                        {user?.profilePhoto ? <img src={user?.profilePhoto} className="profilePhoto" alt="qa_profile" /> : <> <div className="headerlogo">{user?.firstName?.substring(0, 1)}</div></>}
